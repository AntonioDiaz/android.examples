package com.adiaz.expandable.multitypeandcheck;
...
import com.adiaz.expandable.singlecheck.SingleCheckArtistViewHolder;
...
public class MultiTypeCheckGenreAdapter
  ...
  public void onBindChildViewHolder(ChildViewHolder holder, int flatPosition, ExpandableGroup group,
    ...
    switch (viewType) {
      case ARTIST_VIEW_TYPE:
        ((ArtistViewHolder) holder).setArtistName(artist.name());
        break;
      case FAVORITE_VIEW_TYPE:
        ...
        ((SingleCheckArtistViewHolder) holder).setArtistName(artist.name());
    }
  }
